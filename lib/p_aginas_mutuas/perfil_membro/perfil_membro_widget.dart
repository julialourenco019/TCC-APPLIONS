...
import 'perfil_membro_model.dart';
export 'perfil_membro_model.dart';

class PerfilMembroWidget extends StatefulWidget {
  const PerfilMembroWidget({super.key});

  @override
  State<PerfilMembroWidget> createState() => _PerfilMembroWidgetState();
}

class _PerfilMembroWidgetState extends State<PerfilMembroWidget>
    with TickerProviderStateMixin {
  late PerfilMembroModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PerfilMembroModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<MembrosRow>>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData) {
          return Scaffold(
            backgroundColor: FlutterFlowTheme.of(context).backgrondColor2,
            body: Center(
              child: SizedBox(
                width: 50.0,
                height: 50.0,
        ...
        List<MembrosRow> perfilMembroMembrosRowList = snapshot.data!;

        final perfilMembroMembrosRow = perfilMembroMembrosRowList.isNotEmpty
            ? perfilMembroMembrosRowList.first
            : null;
                                                                                    ...
                                                                                    child: Row(
                                                                                      ...
                                                                                      children: [
                                                                                        ...
                                                                                        Padding(
                                                                                          ...
                                                                                          child: Text(
                                                                                            FFLocalizations.of(context).getText(
                                                                                              'girit0rg' /* Configuração de notificação */,
                                                                                            ),
                                                                                            style: FlutterFlowTheme.of(context).labelLarge.override(
                                                                                                  fontFamily: 'Readex Pro',
                                                                                                  letterSpacing: 0.5,
