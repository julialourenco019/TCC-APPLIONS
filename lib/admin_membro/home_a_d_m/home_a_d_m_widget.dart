...
import '/sara_edit/cadastro_reuniao/cadastro_reuniao_widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'home_a_d_m_model.dart';
export 'home_a_d_m_model.dart';

class HomeADMWidget extends StatefulWidget {
  const HomeADMWidget({super.key});

  @override
  State<HomeADMWidget> createState() => _HomeADMWidgetState();
}

class _HomeADMWidgetState extends State<HomeADMWidget> {
  late HomeADMModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeADMModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<MembrosRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<MembrosRow> homeADMMembrosRowList = snapshot.data!;

        final homeADMMembrosRow = homeADMMembrosRowList.isNotEmpty
            ? homeADMMembrosRowList.first
            : null;
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            context.pushNamed('PerfilMembro');
                          },
                          child: Material(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'ouw76fpn' /* Onde há necessidade há um Leão... */,
                                              ),
                                              style:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Image.network(
                                                                            listViewMembrosRow.fotoPerfil == null || listViewMembrosRow.fotoPerfil == ''
                                                                                ? FFAppState().image
