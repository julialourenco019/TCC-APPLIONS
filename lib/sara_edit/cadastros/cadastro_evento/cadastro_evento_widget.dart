...
import 'cadastro_evento_model.dart';
export 'cadastro_evento_model.dart';

class CadastroEventoWidget extends StatefulWidget {
  const CadastroEventoWidget({super.key});

  @override
  State<CadastroEventoWidget> createState() => _CadastroEventoWidgetState();
}

class _CadastroEventoWidgetState extends State<CadastroEventoWidget> {
  late CadastroEventoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastroEventoModel());
                            ...
                            child: Column(
                              ...
                              children: [
                                FFButtonWidget(
                                  ...
                                  text: FFLocalizations.of(context).getText(
                                    'fy6bibjs' /* Valor do ingresso do Evento: */,
                                  ),
                                  options: FFButtonOptions(
                                    height: 40.0,
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                ...
                                Container(
                                  ...
                                  child: SizedBox(
                                    ...
                                    height: 40.0,
                                    child: custom_widgets.TextFieldRealNumber(
