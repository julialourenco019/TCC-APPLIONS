...
import '/sara_edit/editar_membro/editar_membro_widget.dart';
import '/flutter_flow/random_data_util.dart' as random_data;
import 'package:flutter/material.dart';
import 'cadastro_membro_model.dart';
export 'cadastro_membro_model.dart';

class CadastroMembroWidget extends StatefulWidget {
  const CadastroMembroWidget({super.key});

  @override
  State<CadastroMembroWidget> createState() => _CadastroMembroWidgetState();
}

class _CadastroMembroWidgetState extends State<CadastroMembroWidget> {
  late CadastroMembroModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastroMembroModel());
                        ...
                        Align(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FutureBuilder<List<EstadoCivilRow>>(
                                future: EstadoCivilTable().queryRows(
                                  queryFn: (q) => q,
                                ),
                                builder: (context, snapshot) {
                                  ...
                                  List<EstadoCivilRow>
                                      dropDownEstCivilEstadoCivilRowList =
                                      snapshot.data!;

                                  return FlutterFlowDropDown<String>(
                                    controller: _model
                                            .dropDownEstCivilValueController ??=
                                        FormFieldController<String>(null),
                                    options: dropDownEstCivilEstadoCivilRowList
                                        .map((e) => e.estadocivilteste)
                                        .withoutNulls
                                        .toList(),
                                    onChanged: (val) async {
                                      safeSetState(() =>
                                          _model.dropDownEstCivilValue = val);
                                    ...
                                    return FlutterFlowDropDown<String>(
                                      controller:
                                          _model.dropDownWorkValueController ??=
                                              FormFieldController<String>(null),
                                      options: dropDownWorkAdminMembroRowList
                                              ...
                                              if (_model.membroExiste?.length !=
                                                ...
                                                if (_model.membroExiste2
                                                  ...
                                                  if (_model.membroExiste3
                                                    ...
                                                    shouldSetState = true;
                                                    if (_model.membroExiste4
                                                            ?.length !=
                                                        1) {
                                                      // 4
                                                      _model.membroExiste5 =
                                                          await AdminMembroTable()
                                                              .queryRows(
                                                        queryFn: (q) =>
                                                            q.eqOrNull(
                                                          'adminMembroTeste',
                                                      ...
                                                      shouldSetState = true;
                                                      if (_model.membroExiste5
                                                              ?.length ==
                                                          1) {
                                                        _model.membroCadastrado =
                                                            await MembrosTable()
                                                                .insert({
                                                          'Nome': _model
                                                              .textFieldNOMETextController
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  width:
                                                      MediaQuery.sizeOf(context)
                                                              .width *
                                                          0.9,
                                                  child: const EditarMembroWidget(),
                                                ),
                                              ),
                                            );
                                          },
