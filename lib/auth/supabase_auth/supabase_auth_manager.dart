...
class SupabaseAuthManager extends AuthManager with EmailSignInManager {
  ...
  Future updateEmail({
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        '54w40nz7' /* E-mail de confirmação de alter... */,
      ))),
    );
  }
  ...
  Future resetPassword({
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
          content: Text(FFLocalizations.of(context).getText(
        '237f8fjn' /* E-mail de redefinição de senha... */,
      ))),
    );
  }
  ...
  Future<BaseAuthUser?> _signInOrCreateAccount(
    ...
    try {
      ...
      final authUser = user == null ? null : ApplionsSupabaseUser(user);
      ...
      final errorMsg = e.message.contains('User already registered')
          ? FFLocalizations.of(context).getText(
              'gywoow4y' /* E-mail já em uso por outra con... */,
            )
