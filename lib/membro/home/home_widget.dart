  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<MembrosRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<MembrosRow> homeMembrosRowList = snapshot.data!;

        final homeMembrosRow =
            homeMembrosRowList.isNotEmpty ? homeMembrosRowList.first : null;
                                  ...
                                  child: Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        child: Image.network(
                                          homeMembrosRow?.fotoPerfil == null ||
                                                  homeMembrosRow?.fotoPerfil ==
                                                      ''
                                              ? FFAppState().image
                                              : homeMembrosRow!.fotoPerfil!,
                                          fit: BoxFit.cover,
                                          ...
                                          child: Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'v033yvli' /* Onde há necessidade há um Leão... */,
                                              ),
                                              style:
